...
public class Fibonacci {
   ...
   public BrobInt fib(int a) {
      if (a == 0) {
        return new BrobInt("0");
      } else if (a == 1) {
        return new BrobInt("1");
      } else {
        BrobInt first = new BrobInt("0");
        BrobInt second = new BrobInt("1");
        BrobInt replace;
        System.out.println(first + " ");
        while (a != 1) {
          System.out.println(second + " ");
          replace = new BrobInt(second.toString());
          second = second.addByte(first);
          first = new BrobInt(replace.toString());
          a--;
        }
        return second;
      }
